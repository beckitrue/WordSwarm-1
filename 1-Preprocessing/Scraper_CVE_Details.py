...
# Base URL for CVE Details Vulnerability list
baseURL = 'http://www.cvedetails.com/vulnerability-list/'

testURL = 'year-2023/month-1/January.html'
year = ["2018", "2019", "2020", "2021", "2022", "2023"]
month = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"]
url = baseURL + "year-" + year[5] + 'month-2' + month[1]
...
# dets = soup.find_all(attrs={"class": ['cvesummarylong'], 'colspan': '20'})
# print(dets)

dets = soup.find_all("td", class_='cvesummarylong')
for det in dets:
    print(det.contents)
...
#     response = urllib3.urlopen(baseURL + '%s' % k)
